...
?>
<style>
/* uniquement pour que la page prenne bien la place dans l'iframe */
html, body { height: 100%; }
body { margin: 0; }
/* padding léger, pas de changement de fonts */
.sexi-wrap { padding: 15px; }
</style>

<div class="container-fluid sexi-wrap">
  <div class="row">
