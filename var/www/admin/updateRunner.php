...
<?php
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $newVersion = (is_array($matches) && count($matches) > 0) ? $matches[0] : 'Unknown';
			echo '            <div class="alert alert-success" role="alert" style="padding: 5px 15px;"><p><span class="glyphicon glyphicon-hdd" aria-hidden="true"></span> <span style="font-weight: normal;">Current installed version: </span><strong>' . $SexiGrafVersion . '</strong></p><p><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> <span style="font-weight: normal;">New package version: </span><strong>' . $newVersion . '</strong><p></div>
