...
if [ -d "/mnt/wfs/whisper" ]; then
    ...
    nohup /usr/bin/find -L /mnt/wfs/whisper/veeam/ -type f \( -name '*.wsp' \) -exec /usr/local/bin/whisper-resize.py {} 5m:25h 10m:49h 30m:97h 60m:8d 240m:31d 720m:91d 2880m:1y 5760m:2y 17280m:5y --nobackup \; > /var/log/sexigraf/esx_wsp_resize.log 2>&1 &   
