...
if [ -d "/mnt/wfs/whisper" ]; then
    ...
    nohup /usr/bin/find -L /mnt/wfs/whisper/vmw/ -type f \( -name '*.wsp' \) -exec /usr/local/bin/whisper-resize.py {} 5m:25h 10m:49h 30m:97h 60m:8d 240m:31d 720m:91d 2880m:1y 5760m:2y 17280m:5y --nobackup --aggregate \; > /var/log/sexigraf/vmw_wsp_resize.log 2>&1 &
    nohup /usr/bin/find -L /mnt/wfs/whisper/esx/ -type f \( -name '*.wsp' \) -exec /usr/local/bin/whisper-resize.py {} 5m:25h 10m:49h 30m:97h 60m:8d 240m:31d 720m:91d 2880m:1y 5760m:2y 17280m:5y --nobackup --aggregate \; > /var/log/sexigraf/esx_wsp_resize.log 2>&1 &
