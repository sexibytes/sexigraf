	...
	if ($handle = opendir($dir)) {
		...
		while (false !== ($file = readdir($handle))) {
			if ($file != "." && $file != "..") {
				...
				echo '		  <button name="submit" class="btn btn-danger delete" style="width:100px" value="delete-file"><i class="glyphicon glyphicon-trash"></i> Delete</button></form>';
				echo '		  <form class="form" style="display:inline;" action="updateRunner.php" method="post"><input type="hidden" name="input-file" value="' . $file . '"><button name="submit" class="btn btn-primary" style="width:100px" value="update-sexigraf"><i class="glyphicon glyphicon-cog"></i> Upgrade</button>';
				echo '        </form></td></tr>';
		    }
		}
		closedir($handle); 
